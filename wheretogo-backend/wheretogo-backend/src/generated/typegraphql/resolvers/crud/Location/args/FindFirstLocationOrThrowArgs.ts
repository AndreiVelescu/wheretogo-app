...
export class FindFirstLocationOrThrowArgs {
  ...
  distinct?: Array<"id" | "placeId" | "name" | "description" | "type" | "types" | "priceRange" | "vibes" | "address" | "lat" | "lng" | "rating" | "userRatingsTotal" | "website" | "phone" | "googleUrl" | "openHours" | "photos" | "menuPdf" | "popularityScore" | "estimatedCost" | "googleImported" | "createdAt"> | undefined;
}
