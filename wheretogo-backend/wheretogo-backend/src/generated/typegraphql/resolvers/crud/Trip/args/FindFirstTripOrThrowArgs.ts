...
export class FindFirstTripOrThrowArgs {
  ...
  distinct?: Array<"id" | "ownerId" | "title" | "description" | "status" | "startDate" | "endDate" | "city" | "country" | "isPublic" | "totalBudget" | "currency" | "createdAt" | "updatedAt"> | undefined;
}
