...
import { ChatMessageCreateNestedOneWithoutRepliesInput } from "../inputs/ChatMessageCreateNestedOneWithoutRepliesInput";
...
@TypeGraphQL.InputType("ChatMessageCreateWithoutRepliesInput", {})
export class ChatMessageCreateWithoutRepliesInput {
  ...
  @TypeGraphQL.Field(_type => ChatMessageCreateNestedOneWithoutRepliesInput, {
    nullable: true
  })
  replyTo?: ChatMessageCreateNestedOneWithoutRepliesInput | undefined;
