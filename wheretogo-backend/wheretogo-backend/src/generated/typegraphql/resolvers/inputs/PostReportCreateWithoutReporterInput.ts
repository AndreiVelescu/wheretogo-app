...
import { PostCreateNestedOneWithoutReportsInput } from "../inputs/PostCreateNestedOneWithoutReportsInput";
import { ReportReason } from "../../enums/ReportReason";
import { ReportStatus } from "../../enums/ReportStatus";

@TypeGraphQL.InputType("PostReportCreateWithoutReporterInput", {})
export class PostReportCreateWithoutReporterInput {
  ...
  @TypeGraphQL.Field(_type => PostCreateNestedOneWithoutReportsInput, {
    nullable: false
  })
