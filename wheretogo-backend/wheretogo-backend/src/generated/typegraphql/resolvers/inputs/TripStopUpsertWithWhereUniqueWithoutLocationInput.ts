...
@TypeGraphQL.InputType("TripStopUpsertWithWhereUniqueWithoutLocationInput", {})
export class TripStopUpsertWithWhereUniqueWithoutLocationInput {
  ...
  update!: TripStopUpdateWithoutLocationInput;
