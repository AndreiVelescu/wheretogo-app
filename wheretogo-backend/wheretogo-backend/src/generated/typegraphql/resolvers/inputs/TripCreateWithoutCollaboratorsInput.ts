...
import { ChatRoomCreateNestedOneWithoutTripInput } from "../inputs/ChatRoomCreateNestedOneWithoutTripInput";
...
@TypeGraphQL.InputType("TripCreateWithoutCollaboratorsInput", {})
export class TripCreateWithoutCollaboratorsInput {
  ...
  @TypeGraphQL.Field(_type => ChatRoomCreateNestedOneWithoutTripInput, {
    nullable: true
  })
  chatRoom?: ChatRoomCreateNestedOneWithoutTripInput | undefined;
