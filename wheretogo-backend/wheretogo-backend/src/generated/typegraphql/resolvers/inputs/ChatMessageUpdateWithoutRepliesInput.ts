...
@TypeGraphQL.InputType("ChatMessageUpdateWithoutRepliesInput", {})
export class ChatMessageUpdateWithoutRepliesInput {
  ...
  sender?: UserUpdateOneRequiredWithoutChatMessagesNestedInput | undefined;
