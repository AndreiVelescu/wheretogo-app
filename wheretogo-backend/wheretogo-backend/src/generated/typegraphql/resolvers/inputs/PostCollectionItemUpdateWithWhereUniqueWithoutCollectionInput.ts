...
@TypeGraphQL.InputType("PostCollectionItemUpdateWithWhereUniqueWithoutCollectionInput", {})
export class PostCollectionItemUpdateWithWhereUniqueWithoutCollectionInput {
  ...
  data!: PostCollectionItemUpdateWithoutCollectionInput;
}
