...
import { SavedPostUpdateManyWithoutPostNestedInput } from "../inputs/SavedPostUpdateManyWithoutPostNestedInput";
...
@TypeGraphQL.InputType("PostUpdateWithoutCollectionsInput", {})
export class PostUpdateWithoutCollectionsInput {
  ...
  @TypeGraphQL.Field(_type => SavedPostUpdateManyWithoutPostNestedInput, {
    nullable: true
  })
  saves?: SavedPostUpdateManyWithoutPostNestedInput | undefined;
