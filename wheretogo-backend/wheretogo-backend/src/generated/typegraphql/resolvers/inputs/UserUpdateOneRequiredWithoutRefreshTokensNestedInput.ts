...
import { UserUpdateToOneWithWhereWithoutRefreshTokensInput } from "../inputs/UserUpdateToOneWithWhereWithoutRefreshTokensInput";
...
export class UserUpdateOneRequiredWithoutRefreshTokensNestedInput {
  ...
  @TypeGraphQL.Field(_type => UserUpdateToOneWithWhereWithoutRefreshTokensInput, {
    nullable: true
  })
  update?: UserUpdateToOneWithWhereWithoutRefreshTokensInput | undefined;
}
